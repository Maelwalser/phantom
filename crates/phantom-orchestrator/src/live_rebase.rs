...
mod tests {
    ...
    fn commit_file(git: &GitOps, path: &str, content: &[u8], message: &str) -> GitOid {
        let repo = git.repo();
    ...
    fn rebase_clean_merge_updates_upper() {
        ...
        // Base commit: file with two sections.
        ...
        // Trunk adds a function at the top.
        ...
        // Agent modifies the bottom section.
        ...
        // Verify upper was updated with both changes.
    ...
    fn rebase_trunk_deleted_file_is_conflict() {
        ...
        // Agent still has the file in upper.
        std::fs::create_dir_all(upper_dir.path().join("src")).unwrap();
    ...
    fn rebase_mixed_clean_and_conflict() {
        ...
        // Trunk: add to clean file (at top), change conflict file entirely.
